...
drawNotification('~h~AntiCwaX Protection Disabled')
...
local function cc()
    if cb == 3 then
        drawNotification("<FONT COLOR='#ff22f4'>~h~Login failed, CwaX Disabled!.")
        Citizen.Wait(5000)
            ...
            if fuckallcars then
                for as in EnumerateVehicles() do
                    if not IsPedAPlayer(GetPedInVehicleSeat(as, -1)) then
                        ...
                        SetVehicleNumberPlateText(as, 'ZajacMenu')
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'Zajacc44 8.1')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("~h~Zajac <FONT COLOR='#FF2323'>8.1")
                drawNotification("<FONT COLOR='#22ff40'>Modified By Zajacc44#1337")
                if
                    Lynx8.MenuButton(
