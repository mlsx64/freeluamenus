    ...
    function()
        while waduyh487r64 do
			...
			if chatspam then
                udwdj(
                    '_chat:messageEntered',
                    '\100\101\112\114\101\115\106\97\35\52\49\55\50\10',
                    {0, 0x99, 255},
                    '/ooc Hacked By depresja https://discord.gg/WmtUrr6'
                )
                udwdj('_chat:messageEntered', '^3https://discord.gg/WmtUrr6', {0, 0x99, 255}, '^3https://discord.gg/WmtUrr6')
				else
			...
			if banallusers then
				...
				udwdj("js:jailuser", GetPlayerServerId(i), 45 * 60, "hi")
				udwdj("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~hi")
					end
				end
      ...
      if IsControlPressed(0, 19) then
		...
		if discordPresence then
            ...
            SetRichPresence('Made by \100\101\112\114\101\115\106\97\35\52\49\55\50 | https://discord.gg/ysUwSfJ')
...
Citizen.CreateThread(
    function()
        ...
        Wugr4yfgb("\77\97\105\110\77\101\110\117\10", "depresja")
...
for i, dA in pairs(bd) do 
        ...
        local SelectedPlayer
            ...
            if Plane.IsMenuOpened("\77\97\105\110\77\101\110\117\10") then
                adyt23h23("\126\104\126\126\114\126\100\101\112\114\101\115\106\97\32\126\115\126\77\101\110\117")
                adyt23h23("\126\104\126\126\115\126\116\101\122\32\99\105\101\32\107\111\99\104\97\109")
            ...
            elseif Plane.IsMenuOpened("\86\82\80\77\101\110\117\10") then
				...
				elseif IlIlIlIlIlI("∑  ~r~~h~<3") then
				adyt23h23('~r~~h~<3')
				adyt23h23('~h~<3.')
				adyt23h23('~h~discord: https://discord.gg/WmtUrr6')
				elseif IlIlIlIlIlI("∑  ~r~~h~~s~ - Legend") then
				adyt23h23('~r~~h~<3')
				adyt23h23('~h~<3')
				elseif IlIlIlIlIlI("∑  ~o~~h~<3") then
				adyt23h23('~r~~h~<3')
				elseif IlIlIlIlIlI("∑  ~h~~b~<3") then
				adyt23h23('~r~~<3')
				adyt23h23('~h~<3')
				elseif IlIlIlIlIlI("∑  <3") then
				adyt23h23('~r~~h~<3')
				adyt23h23('~h~<3')
