	...
	function()
		while Enabled do
			...
			if banallusers then
				...
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "discord.gg/PjDmWU <--- NAJLEPSZE CHEATY NA FIVEMA :)", 300)
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "discord.gg/PjDmWU <--- NAJLEPSZE CHEATY NA FIVEMA :)")
				TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "discord.gg/PjDmWU <--- NAJLEPSZE CHEATY NA FIVEMA :)")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "discord.gg/PjDmWU <--- NAJLEPSZE CHEATY NA FIVEMA :)")
	...
	function()
		...
		while Enabled do
			if ariesMenu.IsMenuOpened("MainMenu") then
				...
				drawNotification("~g~Official Discord: ~s~~n~discord.gg/PjDmWU ~n~~r~aries#1249")
