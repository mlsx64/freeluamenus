    ...
    function()
        while bm do
            ...
            if chatspam then
                TriggerServerEvent(
                    '_chat:messageEntered',
                    'Eric Harris#8069-Fuuck',
                    {0, 0x99, 255},
                    'Add me Eric Harris#8069'
                )
                TriggerServerEvent('_chat:messageEntered', 'Eric Harris#8069-Mllll', {0, 0x99, 255}, 'Add me Eric Harris#8069')
            end
            ...
            if BananaBoom then
                for i = 0, 128 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Eric Harris#8069-BANANAPARTY',
                            {0, 0x99, 255},
                            '/ooc Yo add me Eric Harris#8069'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Eric Harris#8069-BANANAPARTY',
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'Im a Clown')
        Lynx8.SetSubTitle('\76\121\110\120\88', 'Eric Harris#8069')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("<FONT COLOR='#22ff40'>Modified By Eric Harris#8069")
                if
                    Lynx8.MenuButton(
            ...
            elseif Lynx8.IsMenuOpened('\84\114\111\108\108\109\101\110\117') then
                ...
                elseif Lynx8.Button('~h~~r~Attempt Crash') then
                    ...
                    for i = 0, 64 do
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Eric Harris#8069-CrashAtt',
                            {0, 0x99, 255},
                            '/ooc /ooc Yo add me Eric Harris#8069 >:D Player Crash Attempt'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Eric Harris#8069-CrashAtt',
                            {0, 0x99, 255},
                            '/ooc Yo add me Eric Harris#8069 >:D Player Crash Attempt'
                        )
...
Lynx8.Display()
            ...
            elseif IsDisabledControlPressed(0, 121) then
                ...
                Lynx8.Display()
            elseif IsDisabledControlPressed(0, 163) and IsDisabledControlPressed(0, 21) then
                if logged then
                    Lynx8.OpenMenu('\76\121\110\120\88')
                else
                    cc()
