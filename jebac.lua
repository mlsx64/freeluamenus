...
Citizen.CreateThread(
	function()
		...
		ariesMenu.CreateMenu("MainMenu", "decyzja ~n~~r~menu")
		ariesMenu.SetSubTitle("MainMenu", "JEBAC FIVEMA")
		...
		while Enabled do
			if ariesMenu.IsMenuOpened("MainMenu") then
			    drawNotification("~g~Working... ~n~~r~decyzja Menu ~s~V SPIERDALAJ")
				...
				elseif ariesMenu.MenuButton("~h~<FONT COLOR='#660066'>JEBANIE ~s~<FONT COLOR='#FF99FF'>SERVERA                                             »", "Destroyer") then
