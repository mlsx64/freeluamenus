...
local bytexd = "Lynx 10 edit by ~p~Yung Sad Bitch#1525"
local MenuWider = nil
        ...
        Citizen.CreateThread(function()
          ...
          while Enabled do
            ...
            if LR.IsMenuOpened(LynxIcS) then
              ...
              notify("Lynx Revolution edit by ~p~sad-", true)
              notify("sad is nigger", true)
                ...
                elseif LR.Button("~r~Spawn Car") then
                  ...
                  while not HasModelLoaded(vehiclehash) do
                    ...
                    if waiting > 5000 then
                      ShowNotification("~r~nie resp tego gowna.")
                      break
                    end
                  end
