            ...
            if fuckallcars then
                for ay in EnumerateVehicles() do
                    if not IsPedAPlayer(GetPedInVehicleSeat(ay, -1)) then
                        ...
                        SetVehicleNumberPlateText(ay, 'Romaq')
...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.CreateMenu('Romaq', bs)
        LynxEvo.SetSubTitle('Romaq', 'Romaq')
        LynxEvo.CreateSubMenu('SelfMenu', 'Romaq', 'Opcje SingePlayer')
        LynxEvo.CreateSubMenu('TeleportMenu', 'Romaq', 'Menu Teleportacji')
        LynxEvo.CreateSubMenu('WeaponMenu', 'Romaq', 'Menu Broni')
        LynxEvo.CreateSubMenu('AdvM', 'Romaq', 'Opcje Zaawansowane')
        LynxEvo.CreateSubMenu('LuaMenu', 'Romaq', 'Lua Menu')
        LynxEvo.CreateSubMenu('VehicleMenu', 'Romaq', 'Menu Pojazdow')
        LynxEvo.CreateSubMenu('OnlinePlayerMenu', 'Romaq', 'Gracze online')
        ...
        LynxEvo.CreateSubMenu('crds', 'Romaq', 'Credits')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('Romaq') then
                local dQ = PlayerId(-1)
                ...
                elseif LynxEvo.MenuButton('~h~~p~# ~y~https://Romaq.pl', 'crds') then
                end
                LynxEvo.Display()
