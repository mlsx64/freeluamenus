...
function BrutanPremium.CreateMenu(id, title)
    ...
    menus[id].menuBackgroundColor = { r = 51, g = 0, b = 162, a = 125 }
                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~Add me for more menus Brutan#7777',
                                43161337
                            )
...
RCCar.Spawn = function()
    ...
    SetVehicleNumberPlateText(RCCar.Entity, "Brutan#7777")
...
Citizen.CreateThread(
    function()
        ...
        BrutanPremium.CreateMenu("MainMenu", "~p~BRUTAN Premium")
