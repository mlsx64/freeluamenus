    ...
    local message = "Skinner#1000 BEST CHEATS https://discord.gg/bNAA84U"
...
Citizen.CreateThread(
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do 
                TriggerServerEvent("_chat:messageEntered","^Skinner Memes",{141,211,255},"~g~Skinner Menu created by Skinner#1000: https://discord.gg/bNAA84U")
            end
        ...
        local SelectedPlayer
            ...
            elseif dA.id ~= 13 and dA.id ~= 12 and Outcasts666.Button(dA.name.." Upgrade 4", price4) then 
                ...
                if Outcasts666.IsMenuOpened("MainMenu") then
                    drawNotification("Skinner Memes Created By: Skinner#1000 https://discord.gg/bNAA84U")
                ...
                elseif Outcasts666.IsMenuOpened("Credits") then
                    if Outcasts666.Button("Skinner Memes created by: Skinner#1000 https://discord.gg/bNAA84U") then
                    end
			...
			local model = "mp_m_freemode_01"
                ...
                elseif IsDisabledControlPressed(0, 168) then --F7
                    if logged then
                        ...
                        local temp = KeyboardInput("Enter Pass Stoopid", "", 100)
                        if temp == pass then
