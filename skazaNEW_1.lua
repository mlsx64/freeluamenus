...
local function debugPrint(text)
    if skała.debug then
        Citizen.Trace("[skała] "..tostring(text))
    end
end
...
function skała.CreateMenu(id, title)
    -- Default settings
    menus[id] = { }
...
function skała.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        skała.CreateMenu(id, menus[parent].title)
...
function skała.CurrentMenu()
    return currentMenu
end


function skała.OpenMenu(id)
    if id and menus[id] then
...
function skała.IsMenuOpened(id)
    return isMenuVisible(id)
end


function skała.IsAnyMenuOpened()
...
function skała.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function skała.Button(text, subText)
...
function skała.MenuButton(text, id)
    if menus[id] then
        if skała.Button(text) then
            setMenuVisible(currentMenu, false)
...
function skała.CheckBox(text, checked, callback)
    if skała.Button(text, checked and "~w~~h~On" or "~h~~c~Off") then
        checked = not checked
...
function skała.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if skała.Button(text, selectedItem) then
...
function skała.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function skała.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function skała.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function skała.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function skała.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function skała.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function skała.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function skała.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function skała.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function skała.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function skała.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function skała.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function skała.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function skała.SetMenuButtonPressedSound(id, name, set)
...
Citizen.CreateThread(
    function()
        ...
        skała.CreateMenu("MainMenu", "* skała *")
        skała.CreateSubMenu("SelfMenu", "MainMenu", "Player Menu")
        skała.CreateSubMenu("DestroyServer", "MainMenu", "DestroyServer")
		skała.CreateSubMenu("SerweryPL", "MainMenu", "SerweryPL")
        skała.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
        skała.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
        skała.CreateSubMenu("SingleWeaponMenu", "WeaponMenu", "Single Weapon Spawner")
        skała.CreateSubMenu("MaliciousMenu", "MainMenu", "SKAZAAAAA")
        skała.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
        skała.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
        skała.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
        skała.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
        skała.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
        skała.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
        skała.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
		skała.CreateSubMenu("AI", "MainMenu", "AI Menu")
		skała.CreateSubMenu("Credits", "MainMenu", "Credits")
        skała.CreateSubMenu("PlayerOptionsMenu", "OnlinePlayersMenu", "Player Options")
        skała.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
        skała.CreateSubMenu("LSC", "VehMenu", "Welcome To Los santos customs!")
        skała.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
        skała.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
        skała.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
        skała.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
        skała.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
		skała.CreateSubMenu("zmiana", "SerweryPL", "Zmien sie")
        skała.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
		skała.CreateSubMenu("pedyy", "MainMenu", "Pedy")
        skała.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
        skała.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        skała.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
        skała.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
        skała.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
        skała.CreateSubMenu("SingleWepPlayer", "PlayerOptionsMenu", "Single Weapon Menu")
        skała.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
        skała.CreateSubMenu("VehBoostMenu", "LSC", "Vehicle Booster")
        skała.CreateSubMenu("ESXEasy", "SerweryPL", "Zresp peda")
        ...
        while Enabled do
            if skała.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Official ~s~skała")
                drawNotification("~h~~s~skała ~b~Szmato")
				drawNotification("~h~~b~Ed~b~yt~b~owane ~b~pr~b~z~b~ez: ~g~S~o~k~p~a~w~z~b~a~r~z ")
				if skała.Button('~h~~r~Twoj nick: <FONT COLOR="#8a0000">' .. GetPlayerName(PlayerId(-1)) .. '') then
                elseif skała.MenuButton    ("~b~» ~s~Twoje ~r~Opcje", "SelfMenu") then
				elseif skała.MenuButton("~b~» ~s~Aktywni ~r~Gracze", "OnlinePlayersMenu") then
				elseif skała.MenuButton("~b~» ~s~Ogolne ~r~Menu", "MaliciousMenu") then
                elseif skała.MenuButton("~b~» ~s~Teleport ~r~Menu", "TeleportMenu") then             
                elseif skała.MenuButton("~b~» ~s~Bronie ~r~Menu", "WeaponMenu") then
                elseif skała.MenuButton("~b~» ~s~Samochody ~r~Menu", "VehMenu") then
                elseif skała.MenuButton("~b~» ~s~Trollowanie ~r~Menu", "TrollMenu") then
				elseif skała.MenuButton("~b~» ~s~Menu ~r~Pedow", "pedyy") then
                elseif skała.MenuButton("~b~» ~g~Pieniadze ~r~Menu", "ESXMenu") then
                elseif skała.MenuButton("~b~» ~s~VRP ~r~Opcje", "VRPMenu") then
				elseif skała.MenuButton("~b~» ~s~Zabawa", "AI") then 
				elseif skała.MenuButton("~b~» ~g~~h~Twórca", "Credits") then
                elseif skała.Button("~b~» ~h~~r~Wyłącz Menu") then
                    Enabled = false
                end

                skała.Display()
            elseif skała.IsMenuOpened("VRPMenu") then
                if skała.Button("VRP PayGarage 100$") then
                    piesaries("lscustoms:payGarage", {costs = -100})
                elseif skała.Button("VRP PayGarage 1000$") then
                    piesaries("lscustoms:payGarage", {costs = -1000})
                elseif skała.Button("VRP PayGarage 10 000$") then
                    piesaries("lscustoms:payGarage", {costs = -10000})
                elseif skała.Button("VRP PayGarage 100 000$") then
                    piesaries("lscustoms:payGarage", {costs = -100000})
                elseif skała.Button("VRP Get Driver Licence") then
                    piesaries("dmv:success")
                elseif skała.Button("VRP Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    piesaries("bank:deposit", amount)
                elseif skała.Button("VRP Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    piesaries("bank:withdraw", amount)
                elseif skała.Button("VRP Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    piesaries("vrp_slotmachine:server:2", amount)
                end

                skała.Display()
            elseif skała.IsMenuOpened("TrollMenu") then
                if skała.Button("ESX Server Crasher") then
                ...
                then
				elseif skała.Button("Spawn moutain Lion On Everyone") then
				...
				elseif skała.Button("SWAT W/ Railgun On Everyone") then
