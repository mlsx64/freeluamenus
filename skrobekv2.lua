    ...
    function()
        while true do
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Skrobek kochanie")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Skrobek kochanie")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Skrobek Menu")
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
                ...
                elseif Plane.IsMenuOpened("PlayerESXTriggerMenu") then
                    ...
                    elseif Plane.Button("ESX Send To Jail") then
						...
						TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 323242, "Skrobek to kozak"
				        TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 3242999, "Skrobek to kozak", 43434343)
				        TriggerServerEvent("esx_jailer:chujwdupe", GetPlayerServerId(i), 92943299, "Jebac ten serwer kurwy jebane Skrobek Youtube", 4343434343)
				        TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9943999, "Skrobek to kozak", 5994343)
				        TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, "Sjema", 233214)
                        TriggerServerEvent('esx_jailers:sendToJail', GetPlayerServerId(i), 12324, "Pozdro od skrobka", 323234)
                        TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 432443, "Pozdro od skrobka", 434343)
                        TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 432423, "Elowa skrobek", 324333)
			        	TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 32324, "skrobek elo", 342423)
			        	TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 4342342, "elo skrobek")
			         	TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 43432, "Skrobek Bejbii", 432423)
			           	TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 4342342, "Skrobek bejbii", 4324234)
			        	TriggerServerEvent("esx_jailer:chujwdupe", GetPlayerServerId(i), 99943999, "Jebac ten serwer kurwy jebane Skrobek Youtube", 9943999)
			          	TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9943999, "Kocham cie Skrobek", 9499999)
				        TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 53543535, "Elo skrobek", 342423)
			          	TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 479320, "Elo skrobek", 432432)
	        			TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 534534, "Skrobek elo", 432423)			
		         		TriggerServerEvent('esx_jailer:pierdl', GetPlayerServerId(i), 3000, "elo skrobek", 4342342)
		        		TriggerEvent("esx_jailer:pierdl", GetPlayerServerId(i), 3000, "Elo skrobek", 432407)
	          			TriggerServerEvent("esx_jailer:pierdl", GetPlayerServerId(i), 43423423, "elo skrobek", 42342)
	          			TriggerServerEvent("esx_jailer:sendToJailariesfrajerze", GetPlayerServerId(i), 2343243242432, "elo skrobek", 35325433253)
	         			TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 23432432432, "elo skrobek", 434242)
		        		TriggerServerEvent('esx_jailer:pierdl', GetPlayerServerId(i), 3000, "elo skrobek", 432843)
		        		TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), 3000, "elo skrobek", 432423)
		        		TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), 9937, "elo skrobek", 332400)
		        		TriggerServerEvent('esx_jailer:jebacczitera', GetPlayerServerId(i), 9937, "elo skrobek", 302340)
			          	TriggerServerEvent('esx-qalle-jail:jailPlayer200396', GetPlayerServerId(i), 9937, "elo skrobek", 423432)
		          		TriggerServerEvent('esx_jailer:wpierdoldopaki', GetPlayerServerId(i), 9937,"elo skrobek", 303240)
		         		TriggerServerEvent("esx_jailer:sendToJailhype", GetPlayerServerId(i), 9937, "elo skrobek", 303240)
		          		TriggerServerEvent('esx_jailer:sendToJailf', GetPlayerServerId(i), 9937, "elo skrobek", 303240)
			           	TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 9937, "Siema skrobek", 303240)
			          	TriggerServerEvent("OUJQNE89CBHVYIIUNJHio34ulhs", GetPlayerServerId(i), 2325235, "SIEMANO skrobek", 32432432432)
			         	TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 99243237, "elo skrobek", 3124234)
		         		TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), 94324937, "elo skrobek")
		        		TriggerServerEvent('esx_jailer:sendToJaill', GetPlayerServerId(i), 9432437, "elo skrobek", 305430)
		          		TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), 432434, "elo skrobek", 300543)
		           		TriggerServerEvent("bmjzjadezwsixqucenasqvfxofbgdm:rmlhrtrlqynnxqyjalwgnqmogicmpo", GetPlayerServerId(i), 9923432437, "elo skrobek", 3054304)
		        		TriggerServerEvent("esx_jailer:pierdl", GetPlayerServerId(i), 4323000, "elo skrobek", 432423)
		         		TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 4323000, "elo skrobek", 423423)
	          			TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 439937, "elo skrobek", 304320)
		         		TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 921937, "Skrobek YT", 59823751)
	        			TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 921937, "elo skrobek", 42342342)
		          		TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "elo skrobek", 342342343)
		          		TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "elo skrobek", 3424324)
			          	TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000, "elo skrobek", 423432)
			         	TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "elo skrobek")
			          	TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "elo skrobek", 3244324)
			           	TriggerServerEvent('chatMessageEntered', "SYSTEM", '{ 0, 0, 0 }, GetPlayerNamePlayerId(i), 432423, "Skrobek on YOUTUBE", 432423)
			           	TriggerServerEvent("esx-qalle-jail:jailPlayer",GetPlayerServerId(i), 5000, "elo skrobek", 434234)
                        TriggerServerEvent("esx_jailer:sendToJail",GetPlayerServerId(i),432423, "elo skrobek", 432432)
                        TriggerServerEvent("esx_jail:sendToJail",GetPlayerServerId(i), 4324324, "elo skrobek", 432423)
                        TriggerServerEvent("js:jailuser",GetPlayerServerId(i),432423, "elo skrobek" 432432)
                    elseif Plane.Button("ESX Get Out Of Jail") then
