              ...
              if fefev.Button("~p~#~s~ ~w~Sposob 1") then
                ...
                elseif fefev.IsMenuOpened("OnlinePlayersMenu") then
                    ...
                    elseif fefev.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        elseif fefev.Button("Pociag XD") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                            local prop = "prop_tram_crash_s"
                            while not HasModelLoaded(GetHashKey(prop)) do 
                                Citizen.Wait(0) 
                                RequestModel(GetHashKey(prop)) 
                            end
                        ...
                        elseif fefev.Button("cos smiesznego") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                            local prop = "p_cablecar_s"
                            while not HasModelLoaded(GetHashKey(prop)) do 
                                Citizen.Wait(0) 
                                RequestModel(GetHashKey(prop)) 
                            end
                        ...
                        elseif fefev.Button("te guwno co sie kreci na molo XD") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                            local prop = "prop_Ld_ferris_wheel"
                            while not HasModelLoaded(GetHashKey(prop)) do 
                                Citizen.Wait(0) 
                                RequestModel(GetHashKey(prop)) 
                            end
                        ...
                        elseif fefev.Button("Jakiś kurwa dzwig XD") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                            local prop = "prop_towercrane_01a"
                            while not HasModelLoaded(GetHashKey(prop)) do 
                                Citizen.Wait(0) 
                                RequestModel(GetHashKey(prop)) 
                            end
