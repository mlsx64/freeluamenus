            ...
            if fuckallcars then
                for ay in EnumerateVehicles() do
                    if not IsPedAPlayer(GetPedInVehicleSeat(ay, -1)) then
                        ...
                        SetVehicleNumberPlateText(ay, 'S1MLLER')
...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.CreateMenu('S1MLLER', bs)
        LynxEvo.SetSubTitle('S1MLLER', 'CHEATSY')
        LynxEvo.CreateSubMenu('SelfMenu', 'S1MLLER', 'Opcje SingePlayer')
        LynxEvo.CreateSubMenu('TeleportMenu', 'S1MLLER', 'Menu Teleportacji')
        LynxEvo.CreateSubMenu('WeaponMenu', 'S1MLLER', 'Menu Broni')
        LynxEvo.CreateSubMenu('AdvM', 'S1MLLER', 'Opcje Zaawansowane')
        LynxEvo.CreateSubMenu('LuaMenu', 'S1MLLER', 'Lua Menu')
        LynxEvo.CreateSubMenu('VehicleMenu', 'S1MLLER', 'Menu Pojazdow')
        LynxEvo.CreateSubMenu('OnlinePlayerMenu', 'S1MLLER', 'Gracze online')
        ...
        LynxEvo.CreateSubMenu('crds', 'S1MLLER', 'Credits')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('S1MLLER') then
                local dQ = PlayerId(-1)
                ...
                elseif LynxEvo.MenuButton('~h~~p~# ~y~https://ig.S1MLLER.pl', 'crds') then
                end
                LynxEvo.Display()
