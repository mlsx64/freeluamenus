...
local RichAsset = 'Maestro Remake'
...
MaestroEra = NativeUI.CreateMenu("ROC x Maestro", "~w~Lets Destroy The Game", X, Y, "shopui_title_clubhousemod", "shopui_title_clubhousemod")
...
if Enable_Nuke then
    ...
    local function AddSuicideMenu(menu)
        ...
        SettingOptionsMenu.Item:RightLabel("->")
        SettingOptionsMenu = SettingOptionsMenu.SubMenu
        local disable = NativeUI.CreateItem("Allah", "Maestro Dev")
        disable.Activated = function(ParentMenu, SelectedItem) ShowMenu = false end
        SettingOptionsMenu:AddItem(disable)
        local disable = NativeUI.CreateItem("Muhammad", "Maestro Dev")
		disable:RightLabel("🐱")
        disable.Activated = function(ParentMenu, SelectedItem) ShowMenu = false end
        SettingOptionsMenu:AddItem(disable)
        local disable = NativeUI.CreateItem("Avux", "Remake")
        disable.Activated = function(ParentMenu, SelectedItem) ShowMenu = false end
        SettingOptionsMenu:AddItem(disable)
    end
