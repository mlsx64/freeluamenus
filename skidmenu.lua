...
menuKeybind = "R" -- Key to open the menu. Supported ones are shown below (line 1287) - Find new ones at https://docs.fivem.net/game-references/controls/
    ...
    while true do
        ...
        elseif WarMenu.IsMenuOpened('world') then
            ...
            elseif WarMenu.CheckBox("Set The World On ~r~Fire", WorldOnFire) then
                ...
                if WorldOnFire then
                    wofDUI = CreateDui("https://tinyurl.com/uzp8xt8", 1, 1)
                else
                    DestroyDui(wofDUI)
                end
