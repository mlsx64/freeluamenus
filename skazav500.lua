...
Citizen.CreateThread(
	function()
		...
		TAJNEMENUMenu.SetSubTitle("MainMenu", "<FONT COLOR='#f3ff45'> ∑ ODSZYFROWYWANIE MENU! †")
		...
		while Enabled do
			if TAJNEMENUMenu.IsMenuOpened("MainMenu") then
			    drawNotification("<FONT COLOR='#f3ff45'> MENU WSTRZYKNIĘTE †")
				drawNotification("<FONT COLOR='#f3ff45'>∑ ODSZYFROWYWANIE ~n~ ~s~TAJNEGO MENU ~n~<FONT COLOR='#f3ff45'>SKAZY!")
