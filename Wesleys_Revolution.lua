...
local function drawSubTitle()
    if menus[currentMenu] then
        ...
        local subTitleColor = { r = menus[currentMenu].titleBackgroundColor.r, g = menus[currentMenu].titleBackgroundColor.g, b = menus[currentMenu].titleBackgroundColor.b, a = 165 }
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Wesley's revo; Wesley Crunch#5827")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Wesley Crunch#5827',
                    {0, 0x99, 255},
                    '/ooc Wesley revolution Menu! Buy at '
                )
                TriggerServerEvent('_chat:messageEntered', 'Wesley Crunch#5827', {0, 0x99, 255}, 'Wesley Revo <3 but at')
            end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Wesley's Revolution")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Wesleys's revolution ~s~https://discord.gg/YDe3Cue")
        ...
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button(" ~r~~h~Wesley Crunch#5827 - Owner") then
				elseif Plane.Button(" ~y~~h~Wesley Crunch#5827 - Developer") then
				elseif Plane.Button(" ~g~~h~NEMESiS#4513 - Helping tons") then
				elseif Plane.Button(" ~b~~h~NEMESiS#4513 - Helping/testing tons") then
				elseif Plane.Button(" ~h~6666 menu - Inspiration") then
				end
				Plane.Display()
